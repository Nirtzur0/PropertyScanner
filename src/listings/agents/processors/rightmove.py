...
class RightmoveNormalizerAgent(BaseAgent):
    """
    Parses HTML snippets from Rightmove into CanonicalListings.
    Prefers JSON-LD when present.
    """

    def __init__(self) -> None:
        super().__init__(name="RightmoveNormalizer")
    ...
    def run(self, input_payload: Dict[str, Any]) -> AgentResponse:
        ...
        for raw in raw_listings:
            try:
                ...
                errors.append(f"rightmove_norm_error:{getattr(raw, 'external_id', 'unknown')}:{exc}")
