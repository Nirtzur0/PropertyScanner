...
class SeLogerCrawlerAgent(BaseAgent):
    ...
    def __init__(self, config: Dict[str, Any], compliance: ComplianceManager):
        ...
        self.source_id = canonicalize_source_id(config.get("id", "seloger_fr"))
        self.base_url = config.get("base_url", "https://www.seloger.com")
        rate_conf = config.get("rate_limit", {}) or {}
        self.rate_limit_seconds = float(rate_conf.get("period_seconds", config.get("period_seconds", 30)))
        ...
        self.scrape_client = ScrapeClient(
            ...
            rate_limit_seconds=self.rate_limit_seconds, # Slower pace
