...
from src.listings.services.feature_sanitizer import sanitize_listing_dict
...
def save_listings_to_db(
    ...
    *,
    ...
    listing_persistence = ListingPersistenceService(listings_repo)
    ...
    return listing_persistence.save_listings(canonical_listings)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--db", default=str(defaults.pipeline.db_path), help="Database path")
    
    args = parser.parse_args()
    
    total = collect_data(target_count=args.target, db_path=args.db, app_config=defaults)
