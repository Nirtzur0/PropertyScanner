...
HARVEST_SEEN_URLS_DB = _env_path("PROPERTY_SCANNER_HARVEST_SEEN_DB", DATA_DIR / "harvest_seen_urls.sqlite3")
HARVEST_URLS_SALE = _env_path("PROPERTY_SCANNER_HARVEST_URLS_SALE", DATA_DIR / "harvest_urls_sale.json")
HARVEST_URLS_RENT = _env_path("PROPERTY_SCANNER_HARVEST_URLS_RENT", DATA_DIR / "harvest_urls_rent.json")
HARVEST_STATE_SALE = _env_path("PROPERTY_SCANNER_HARVEST_STATE_SALE", DATA_DIR / "harvest_state_sale.json")
HARVEST_STATE_RENT = _env_path("PROPERTY_SCANNER_HARVEST_STATE_RENT", DATA_DIR / "harvest_state_rent.json")
