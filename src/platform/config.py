...
VECTOR_INDEX_PATH = _env_path("PROPERTY_SCANNER_VECTOR_INDEX_PATH", DATA_DIR / "vector_index.lancedb")
VECTOR_METADATA_PATH = _env_path("PROPERTY_SCANNER_VECTOR_METADATA_PATH", DATA_DIR / "vector_metadata.json")
LANCEDB_PATH = _env_path("PROPERTY_SCANNER_LANCEDB_PATH", VECTOR_INDEX_PATH)
